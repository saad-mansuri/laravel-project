        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-12 main-head-service">
                    <p> <b>MOBILE DEVELOPMENT</b> COST CALCULATOR</p>
                </div>
            </div>
                ...
                <div class="cost-section ">
                    ...
                    <div class="row">
                        <div class="col-md-12 mobileappdev">
                            <p>Mobile Development Cost Estimate</p>
                        </div>
                    </div>
                    ...
                    <div id="popup1" class="overlay">
                        <div class="popup">
                            ...
                            <!-- <h2 class="mb-4">with filling some contact details</h2> -->
                            <a class="close" href="#">&times;</a>
                            <form method="POST" action="/addmobdevelop">
                            @csrf
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-md-4">
                                            <input class="form-control" style="text-align:center" name="apps" type="text"
                                                placeholder="MOBILE DEVELOPMENT" value="MOBILE APP DEVELOPMENT" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 contact-form">
                                            ...
                                            <!-- <select class="form-control" name="budget">
                                                ...
                                                <option value="$30000 - $50000"><i class="fa fa-inr"></i>30000 - <i
