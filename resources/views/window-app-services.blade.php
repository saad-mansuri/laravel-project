        ...
        <div class="container mt-0">
            <div class="row">
                <div class="col-md-12 main-head-service">
                    <p> <b>WINDOW APP DEVELOPMENT</b> COST CALCULATOR</p>
                </div>
            </div>
                ...
                <div class="cost-section ">
                    ...
                    <div class="row">
                        <div class="col-md-12 mobileappdev">
                            <p>Window Development Cost Estimate</p>
                        </div>
                    </div>
                    ...
                    <div id="popup1" class="overlay">
                        ...
                        <h2 class="mb-3"><b>Submit your project with contact details</b></h2>
                            ...
                            <form method="POST" action="/addwindowdevelop">
                            @csrf
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-md-4">
                                            <input class="form-control" style="text-align: center;" name="apps" type="text"
                                                placeholder="WINDOW APP DEVELOPMENT" value="WINDOW APP DEVELOPMENT" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 contact-form">
                                            ...
                                            <!-- <select class="form-control" name="budget">
                                                ...
                                                <option value="$1000 - $30000"><i class="fa fa-inr"></i>30000 - <i
                                        ...
                                        <div class="col-md-6 contact-form">
                                            ...
                                            <div class="form-group">
                                                <input type="phone" required="required" class="form-control"
                                                    name="wpnumber" placeholder="WhatsApp Number">
                                            </div>
