...
<body>
    ...
    <section>
        <div class="container about-container">
            <h1 class="about-us-sp">About Us</h1><hr>

            <div class="row my-4">
                <div class="col-md-4 col-sm-6">
                    <div class="mt-5">
                        <a>
                            <i class="fa fa-map-marker" aria-hidden="true"> </i> 1778, CPI
                            Sarkhej-Gandhinagar Highway.
                        </a><br>

                       <br> <a>
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                            codsite@gmail.com</a><br>
                        <br><a href="tel:6353121872"> 
                ...
                <div class="col-md-8 col-sm-6">
                    <div>
                        <img class="about-img-png" src="/image/about-us-logo.png" class="w-100 h-80"> 
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="content-codex">
                        <p class="text-justify font-size-21">codeXsite is well known to craft the most
                            ...
                            We believe
                            in delivering the services without compromising on time and quality.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="content-codex">
                        <p class="text-justify font-size-21">
                            ...
                            in delivering the services without compromising on time and quality.
                             ...
                             <!-- We create perfect solutions to solve your specific
                            problems.
    ...
    <section>
        <footer>
            <nav class="navbar bg-light justify-content-center my-footer">
                <b>
                    <p></p>Copyright<sup>©</sup> #Recharge.<p></p>
                </b>
            </nav>
        </footer>
    </section>
